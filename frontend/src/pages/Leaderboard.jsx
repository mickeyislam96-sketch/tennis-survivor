    ...
    <div className="lb-page">
      ...
      <Section tone="canvas" size="md">
        ...
        {/* Survivometer — uses (n-1) denominator so lone survivor = 100%.
            In a survivor pool, N enter and N-1 will be eliminated; the "field"
            being eliminated is total - 1, and 100% means a winner has emerged.
            This is the correct survivor-pool semantic — do not change without
            thinking it through. */}
        {totalEntrants > 1 && (
