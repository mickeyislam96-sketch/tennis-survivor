/**
 * Monte Carlo Masters 2026 â tournament configuration.
 ...
 *
 * Tournament dates: 5â12 April 2026
 * Draw released: Friday 3 April 2026 at 5pm CEST
 * Qualifying: Sat 4 Apr â Sun 5 Apr
 * Main draw play: Mon 6 Apr â Sun 12 Apr
 *
 * Schedule (confirmed from ATP / LTA / search results):
 *   Sun 5 Apr  â First round (R1), starts 10:00 BST / 11:00 CEST
 *   Mon 6 Apr  â First round continued (R1)
 *   Tue 7 Apr  â Second round (R32, seeds enter)
 *   Wed 8 Apr  â Third round (R16)
 *   Thu 9 Apr  â Third round continued (R16)
 *   Fri 10 Apr â Quarter-finals
 *   Sat 11 Apr â Semi-finals
 *   Sun 12 Apr â Final
 *
...
export const MONTE_CARLO_2026 = {
  ...
  // Round order â no R64 layer; seeds enter directly at R32.
  ...
  //   1/16-finals = R32 (seeds enter, 32 â 16)
  ...
  // apiSeason omitted â API-Tennis returns empty when tournament_season is
  // included for Monte Carlo. Omitting it returns correct fixtures.
  apiSeason:    null,

  // Manual result overrides â for matches where API-Tennis has no fixture
  ...
  // Lock time overrides â 1h before first match of each round.
  ...
  lockTimeOverrides: {
    R1:  '2026-04-05T11:30:00Z', // Sun 5 Apr, 12:30 BST â qualifying in the morning
    R32: '2026-04-07T10:00:00Z', // Tue 7 Apr, 11:00 BST / 12:00 CEST â no R32 matches before 11:30 BST
  ...
  windowOpensOverrides: {
    R16: '2026-04-07T16:00:00Z', // Mon 7 Apr, 5pm BST â let R32 results settle before R16 opens
  },

  // Fallback schedule â used when API returns no data at all.
  roundDates: {
  ...
  // Round date fallback â API has fixtures but no start times yet.
  roundDateFallback: {
