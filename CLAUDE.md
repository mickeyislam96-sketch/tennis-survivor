...
> Last updated: 9 May 2026 (session 38c — email redesign Direction A: dark-mode safe via color-scheme meta + @media + [data-ogsc] for Outlook 365, mobile breakpoint, system-font fallback chain, Welcome trimmed). See "Session-end protocol" at the bottom of this file — follow it at the end of every session.
