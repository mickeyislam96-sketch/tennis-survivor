...
> Last updated: 22 May 2026 (session 41 — pre-launch QA audit of Roland Garros; fixed free-pool UI: betaFree flag was dead so free pools showed "£0"/"Join for £0"/non-refundable; now derive free from entryFeeCents===0). See "Session-end protocol" at the bottom of this file — follow it at the end of every session.
