...
> Last updated: 1 June 2026 (session 42 — RG live-incident response: a STAGING scraper was scraping Rome and POSTing to the PRODUCTION backend hourly, clobbering RG data; the wrong-event guard then dropped it so bracket/leaderboard/pick-pool broke. Repointed the staging scraper (Railway, via Chrome); healed prod; recorded 2 R64 walkover winners; fixed the leaderboard grader to enforce non-picker elimination). See "Session-end protocol" at the bottom of this file — follow it at the end of every session.
...
## Current tournament state (as of 1 June 2026)
...
### Roland Garros 2026 (ACTIVE — at QF stage as of 1 Jun; entry closed)
- Tournament: Roland-Garros 2026 (Grand Slam, 128 draw, clay). **First Grand Slam this codebase has run.**
- Status: `active`. R1–R16 played; **QF window opens 2026-06-01 17:00 UTC, locks 2026-06-02 08:00 UTC**.
- **Live pool state (1 Jun 2026):** 5 entrants, **1 still in — Servena Williams (survived 4, sole survivor)**. Out: Casper (R32, non-picker), Mick (R64), Rafa (R1), Sabalenka (R1). No official winner yet (Option B: declared only at tournament completion).
